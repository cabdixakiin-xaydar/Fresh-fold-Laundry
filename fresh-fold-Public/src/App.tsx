    ...
    <header className="site-header">
      <div className="shell site-header__inner">
        ...
        <div className="site-actions">
          ...
          <a className="primary-button primary-button--sm" href="#services">
            Book Now
          </a>
...
function Hero() {
  ...
  function onTrackSubmit(event: FormEvent) {
    ...
    setTrackingMessage(`Tracking lookup queued for ${trimmedCode}. Public order-tracking UI can be connected next.`)
  }
            ...
            <div className="tracking-card__row">
              <div className="tracking-input">
                ...
                <input
                  ...
                  placeholder="Enter Order ID (e.g., FF-1234)"
                />
              </div>
